  ...
  const menu = (
    <Menu className="sortby-dropdown-menu">
      <div className="sortby-dropdown-menu-container flex flex-column">
        ...
        <span
          onClick={() => handleSort(sortBy.DateUpdatedNew)}
          className={clsx("sort-item", {
            "text-selected": currentFilter.sort === sortBy.DateUpdatedNew
          })}
        >
          Newest Updated Date
        </span>
        <span
          onClick={() => handleSort(sortBy.DateUpdatedOld)}
          className={clsx("sort-item", {
            "text-selected": currentFilter.sort === sortBy.DateUpdatedOld
          })}
        >
          Oldest Updated Date
        </span>
